...
@pytest.mark.parametrize(
    ...
    [
        ("ndvi", "NDVI", ("nir", "red"), ("SR_B5", "SR_B4"), (300, 100)),
        ("ndwi", "NDWI", ("green", "nir"), ("SR_B3", "SR_B5"), (300, 100)),
        ("nbr", "NBR", ("nir", "swir2"), ("SR_B5", "SR_B7"), (300, 100)),
        ("ndmi", "NDMI", ("nir", "swir1"), ("SR_B5", "SR_B6"), (300, 100)),
    ],
)
...
def test_compute_and_save_landsat_8_ndvi(tmp_path: Path) -> None:
